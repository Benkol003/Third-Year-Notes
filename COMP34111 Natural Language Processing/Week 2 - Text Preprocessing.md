...
![[Pasted image 20231003103949.png]]
...
![[Pasted image 20231003104545.png]]
...
![[Pasted image 20231003112122.png]]
...
![[Pasted image 20231003113834.png]]
...
- Unigram probabilistic model: Assign a probability to each word, and multiply together. We are assuming the words appeared independently and identically distrubuted in terms of occurence. Later apply bayesian inference? ![[Pasted image 20231003114351.png]]
...
**Count-based estimation**: For a N-gram model, we count the number of occurrence of a word $w_k$ with a N-1 previous words $w_{k-1},\ldots w_{k-N+1}$, we calculate the maximum likelihood probability thus:
![[Pasted image 20231003144340.png]]
